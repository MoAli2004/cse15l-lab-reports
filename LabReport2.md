...
I learned how to set up and use the JUnit framework to test code. I have an okay experience with Java, I've never had to set up a unit testing framework for Java before. So this new knowledge of JUnit is greatly beneficial, since testing code is an extremely crucial skill.I also learned how to apporach debugging code as sometimes it may look good to you without knowing how the code may run when given certain inputs.
